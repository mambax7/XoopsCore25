...
define('_AM_SYSTEM_USERS_NAV_DELETE_USER', 'Delete user');
// Tips
...
define('_AM_SYSTEM_USERS_LASTLOGMORE', "Last login is more than <span style='color:#ff0000;'>X</span> days ago");
define('_AM_SYSTEM_USERS_LASTLOGLESS', "Last login is less than <span style='color:#ff0000;'>X</span> days ago");
define('_AM_SYSTEM_USERS_REGMORE', "Joined date is more than <span style='color:#ff0000;'>X</span> days ago");
define('_AM_SYSTEM_USERS_REGLESS', "Joined date is less than <span style='color:#ff0000;'>X</span> days ago");
define('_AM_SYSTEM_USERS_POSTSMORE', "Number of Posts is greater than <span style='color:#ff0000;'>X</span>");
define('_AM_SYSTEM_USERS_POSTSLESS', "Number of Posts is less than <span style='color:#ff0000;'>X</span>");
